...
if(CONFIG_SOC_MCXN947_CPU0 OR CONFIG_SECOND_CORE_MCUX)
  ...
  board_runner_args(linkserver  "--device=MCXN947:MCXN947-PROTOCARD")
...
# Probe-RS support
board_runner_args(probe-rs "-O=--chip-description-path=${BOARD_DIR}/support/MCXN947.yaml" "--chip=MCXN947" "--speed" "'5000'")
